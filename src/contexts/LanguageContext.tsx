...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    "chat.deleteChatConfirm": "Bạn có chắc muốn xóa cuộc trò chuyện này? Cuộc trò chuyện sẽ bị ẩn khỏi danh sách của bạn.",
    "chat.deleteChatSuccess": "Đã xóa cuộc trò chuyện",
    "chat.deleteChatError": "Không thể xóa cuộc trò chuyện",
    "chat.archiveChat": "Lưu trữ",
    "chat.archiveChatSuccess": "Đã lưu trữ cuộc trò chuyện",
    "chat.archiveChatError": "Không thể lưu trữ cuộc trò chuyện",
    "chat.unarchiveSuccess": "Đã bỏ lưu trữ cuộc trò chuyện",
    "chat.archivedChats": "Đã lưu trữ",
    "chat.noArchivedChats": "Không có cuộc trò chuyện nào được lưu trữ",
    ...
    "group.searchFriends": "Tìm kiếm bạn bè...",
    "group.noFriends": "Không có bạn bè",
    "group.next": "Tiếp theo",
    "group.selected": "đã chọn",
    "group.groupNamePlaceholder": "Nhập tên nhóm...",
    "group.participants": "Thành viên",
    "group.you": "Bạn",
    "group.admin": "Quản trị viên",
    "group.back": "Quay lại",
    "group.create": "Tạo nhóm",
    "group.success": "Thành công",
    "group.created": "Đã tạo nhóm thành công",
    "group.error": "Lỗi",
    "group.createFailed": "Không thể tạo nhóm",
    "group.minMembers": "Vui lòng chọn ít nhất 1 thành viên",
    "group.nameRequired": "Vui lòng nhập tên nhóm",
    "group.groupInfo": "Thông tin nhóm",
    "group.members": "thành viên",
    "group.addMember": "Thêm thành viên",
    "group.makeAdmin": "Đặt làm quản trị viên",
    "group.removeAdmin": "Bỏ quyền quản trị",
    "group.removeMember": "Xóa khỏi nhóm",
    "group.leaveGroup": "Rời nhóm",
    "group.nameUpdated": "Đã cập nhật tên nhóm",
    "group.updateFailed": "Không thể cập nhật",
    "group.madeAdmin": "Đã đặt làm quản trị viên",
    "group.removedAdmin": "Đã bỏ quyền quản trị",
    "group.roleFailed": "Không thể thay đổi quyền",
    "group.memberRemoved": "Đã xóa thành viên",
    "group.removeFailed": "Không thể xóa thành viên",
    "group.leftGroup": "Đã rời nhóm",
    "group.leaveFailed": "Không thể rời nhóm",
    "group.leaveGroupTitle": "Rời nhóm?",
    "group.leaveGroupDescription": "Bạn sẽ không nhận được tin nhắn từ nhóm này nữa.",
    "group.leave": "Rời nhóm",
    "group.removeMemberTitle": "Xóa thành viên?",
    "group.removeMemberDescription": "Thành viên này sẽ bị xóa khỏi nhóm.",
    "group.remove": "Xóa",
    "group.noFriendsToAdd": "Không còn bạn bè để thêm",
    "group.memberAdded": "Đã thêm thành viên",
  ...
  en: {
    ...
    "chat.deleteChatConfirm": "Are you sure you want to delete this conversation? It will be hidden from your list.",
    "chat.deleteChatSuccess": "Conversation deleted",
    "chat.deleteChatError": "Could not delete conversation",
    "chat.archiveChat": "Archive",
    "chat.archiveChatSuccess": "Conversation archived",
    "chat.archiveChatError": "Could not archive conversation",
    "chat.unarchiveSuccess": "Conversation unarchived",
    "chat.archivedChats": "Archived",
    "chat.noArchivedChats": "No archived conversations",
    ...
    "group.noFriends": "No friends",
    "group.next": "Next",
    "group.selected": "selected",
    "group.groupNamePlaceholder": "Enter group name...",
    ...
    "group.minMembers": "Please select at least 1 member",
    ...
    "group.updateFailed": "Could not update",
    "group.madeAdmin": "Made admin",
    "group.removedAdmin": "Admin removed",
    "group.roleFailed": "Could not change role",
    "group.memberRemoved": "Member removed",
    "group.removeFailed": "Could not remove member",
    "group.leftGroup": "Left group",
    "group.leaveFailed": "Could not leave group",
    "group.leaveGroupTitle": "Leave group?",
    "group.leaveGroupDescription": "You will no longer receive messages from this group.",
    "group.leave": "Leave",
    "group.removeMemberTitle": "Remove member?",
    "group.removeMemberDescription": "This member will be removed from the group.",
    "group.remove": "Remove",
    "group.noFriendsToAdd": "No more friends to add",
